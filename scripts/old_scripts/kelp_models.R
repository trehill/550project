...
#Model 7: random effect: Transect + Month 
m7 <- glmer(kelp_presence_transect ~ (1|Transect) + (1|Month), 
            data = data, 
            family = binomial)
...
#from this- the model with random effects with the least AIC by far is Transect ONLY 
...
#Model 7: Random effects: Trasect Transect Transect Fixed effects: urchin presence
m7 <- glmer(kelp_presence_transect ~ urchin_presence_transect + (1|Transect), 
            data = data, 
            family = binomial)
...
plot_model(m7, sort.est=TRUE, vline.color = "black", title = "Kelp Presence")

#Model 8: Random effects: Transect Fixed effects: invertebrate richness
m8 <- glmer(kelp_presence_transect ~ invert_richness_sum + (1|Transect), 
            data = data, 
            family = binomial)

AIC8 <- AIC(m8)

#Model 9: Random effects: Transect Fixed effects: substrate
m9 <- glmer(kelp_presence_transect ~ Substrate + (1|Transect), 
            data = data, 
            family = binomial,
...
#Model 10: Random effects: Transect Fixed effects: urchin presence, invert richness
m10 <- glmer(kelp_presence_transect ~ urchin_presence_transect + invert_richness_sum + (1|Transect), 
             data = data, 
             family = binomial)

AIC10 <- AIC(m10)

#Model 11: Random effects: Transect Fixed effects: urchin presence, substrate
m11 <- glmer(kelp_presence_transect ~ urchin_presence_transect + Substrate + (1|Transect), 
             data = data, 
             family = binomial, 
             control = glmerControl(optimizer = "bobyqa"))
...
#Model 12: Random effects: Transect, Fixed effects: invert richness, substrate
m12 <- glmer(kelp_presence_transect ~ invert_richness_sum + Substrate + (1|Transect), 
             data = data, 
             family = binomial)

AIC12 <- AIC(m12)

#Model 13: Random: Transect, Fixed: urchin, depth
m13 <- glmer(kelp_presence_transect ~ urchin_presence_transect + avg_depth +(1|Transect), 
             data = data, 
             family = binomial)

AIC13 <- AIC(m13)

#Model 14: Random: Transect, Fixed: urchin, depth, substrate
m14 <- glmer(kelp_presence_transect ~ urchin_presence_transect + avg_depth + Substrate + (1|Transect), 
             data = data, 
             family = binomial, 
...
#Model 15: Random: Transect, Fixed: urchin, depth, substrate,invert
m15 <- glmer(kelp_presence_transect ~ urchin_presence_transect + avg_depth + Substrate + invert_richness_sum + (1|Transect), 
             data = data, 
             family = binomial, 
             control = glmerControl(optimizer = "bobyqa"))
...
m <- glmer(kelp_presence_transect ~ urchin_presence_transect + invert_richness_sum + Substrate + avg_depth + (1|Transect), 
             data = data, 
             family = binomial)
m
